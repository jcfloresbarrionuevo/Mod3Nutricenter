...
EXPOSE 8080
EXPOSE 8081
ENV DB_CONECTION_STRING="Server=154.53.50.174\\SQLEXPRESS; DataBase=DBNur;User ID=usNur;Password=xyz.789;Application Name=DBNur;TrustServerCertificate=True;Application Name=DBNur"
